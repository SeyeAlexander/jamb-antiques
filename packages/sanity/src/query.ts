...
const imageArrayItemFields = /* groq */ `
  _key,
  ${imageFields}
`;

const textImageBlockFragment = /* groq */ `
...
const collectionGridBlockFragment = /* groq */ `
...
const brandStripBlockFragment = /* groq */ `
  _type == "brandStripBlock" => {
    ...,
    "images": array::compact(images[]{
      ${imageArrayItemFields}
    })
  }
`;
...
const pageBuilderFragment = /* groq */ `
  pageBuilder[]{
    ...
    ${collectionGridBlockFragment},
    ${brandStripBlockFragment}
  }
`;
