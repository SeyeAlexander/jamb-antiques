...
import { HeroBlock as JambHeroBlock } from "./jamb-sections/hero-block";
import { TextImageBlock } from "./jamb-sections/text-image-block";
import { CollectionGridBlock } from "./jamb-sections/collection-grid-block";
import { BrandStripBlock } from "./jamb-sections/brand-strip-block";
...
const BLOCK_COMPONENTS = {
  ...
  brandStripBlock: BrandStripBlock,
...
export function PageBuilder({ pageBuilder: initialBlocks = [], id, type }: PageBuilderProps) {
  ...
  return (
    <main className='jamb-stack pt-24 w-full' data-sanity={containerDataAttribute}>
